...
CREATE INDEX `oauth_access_token_code_id_idx` ON `oauth_access_token` (`authorization_code_id`);--> statement-breakpoint
...
CREATE INDEX `oauth_refresh_token_code_id_idx` ON `oauth_refresh_token` (`authorization_code_id`);--> statement-breakpoint
