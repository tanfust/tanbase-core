...
| ------------- | ------------------------------------- | -------------------------------------- | -------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Local         | Working tree based on `3ae705f`       | `http://localhost:3005`                | 2026-09-19           | 30 runtime tests, verify, local smoke, protected redirect, production dry run, and generated-type drift check passed |
