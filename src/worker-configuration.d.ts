/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/typegen.env src/worker-configuration.d.ts` (hash: a8090c6167cafc47b0adb2ed569e2dda)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	APP_ENV: "production" | "local";
	BETTER_AUTH_URL: "https://tanbase-core.tanfust.com" | "http://localhost:3000";
	EMAIL_FROM: "";
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		DB: D1Database;
		APP_ENV: "production";
		BETTER_AUTH_URL: "https://tanbase-core.tanfust.com";
		EMAIL_FROM: "";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL" | "EMAIL_FROM">> {}
}
