/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/typegen.env src/worker-configuration.d.ts` (hash: 9e897f126041728727210fd81d6e9dee)
...
interface __BaseEnv_Env {
	...
	BETTER_AUTH_URL: "https://core.tanbase.dev" | "http://localhost:3000";
	EMAIL_FROM: "noreply@send.tanbase.dev" | "";
	TURNSTILE_SITE_KEY: "0x4AAAAAAFCqjjSEV5UqAPfK" | "1x00000000000000000000AA";
	POSTHOG_HOST: "https://eu.i.posthog.com" | "";
	AI_MODEL: "@cf/mistralai/mistral-small-3.1-24b-instruct";
	AI_GATEWAY_ID: "default";
	AI_DAILY_LIMIT: "20";
	BOARD: DurableObjectNamespace<import("./server").BoardRoom>;
	BREAKDOWN: Workflow<Parameters<import("./server").TaskBreakdownWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL" | "EMAIL_FROM" | "TURNSTILE_SITE_KEY" | "POSTHOG_HOST" | "AI_MODEL" | "AI_GATEWAY_ID" | "AI_DAILY_LIMIT">> {}
}
